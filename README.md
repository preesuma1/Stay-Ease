Here’s a **clean, structured project documentation** for your Airbnb-like booking system using **Python + Django**, including **Khalti payment integration** and **real-time chat**.
...
1. User selects property → clicks “Book”
2. Redirect to Khalti payment
3. Payment verification via backend
4. Booking confirmed upon success
...
1. Guest opens property
2. Clicks “Chat with Host”
3. WebSocket connection established
4. Messages exchanged instantly
